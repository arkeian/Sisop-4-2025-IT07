...
<p align="justify">
&emsp; Pada Soal 4: Chiho, terdiri dari satu program yaitu <code>maimai_fs.c</code> yang memiliki fungsi untuk membuat sebuah sistem <code>FUSE</code> pada direktori virtual <code>fuse_dir</code> dan direktori asli <code>chiho</code>. Soal ini terdiri atas tujuh subsoal di mana masing-masing subsoal bermain dengan sistem pembuatan dan pembacaan direktori, pembuatan dan akses file, serta penulisan dan pembacaan terhadap suatu file. Secara keseluruhan, program <code>maimai_fs</code> memiliki tampilan sebagai berikut:
</p>
...
<p align="justify">
&emsp; Adapun tampilan preprocessors yang digunakan pada program <code>maimai_fs</code> agar dapat berjalan adalah sebagai berikut:
</p>
...
<p align="justify">
&emsp; Sedangkan, pada program yang mengimplementasikan <code>FUSE</code> ini, dibuatlah operasi-operasi terkait manajemen filesystem. Adapun pada program ini, operasi filesystem yang digunakan adalah <code>getattr</code>, <code>readdir</code>, <code>open</code>, <code>read</code>, <code>write</code>, <code>create</code>, dan <code>unlink</code>.
</p>

<p align="justify">
&emsp;&emsp; Di mana tampilan setiap function operasi filesystem pada program <code>maimai_fs</code> agar dapat berjalan adalah sebagai berikut:
</p>

&emsp;&emsp;&emsp; 1) <code>getattr</code> dengan alias <code>mai_getattr</code>
...
&emsp;&emsp;&emsp; 2) <code>readdir</code> dengan alias <code>mai_readdir</code>
...
&emsp;&emsp;&emsp; 3) <code>open</code> dengan alias <code>mai_open</code>
...
&emsp;&emsp;&emsp; 4) <code>read</code> dengan alias <code>mai_read</code>
...
&emsp;&emsp;&emsp; 5) <code>write</code> dengan alias <code>mai_write</code>
...
&emsp;&emsp;&emsp; 6) <code>create</code> dengan alias <code>mai_create</code>
...
&emsp;&emsp;&emsp; 7) <code>unlink</code> dengan alias <code>mai_unlink</code>
